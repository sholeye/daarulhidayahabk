  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        unpaid: "border-transparent bg-destructive/10 text-destructive",
        partial: "border-transparent bg-secondary/10 text-secondary",
        present: "border-transparent bg-primary/10 text-primary",
        absent: "border-transparent bg-destructive/10 text-destructive",
        late: "border-transparent bg-secondary/10 text-secondary",
      },
    },
    defaultVariants: {
      variant: "default",
