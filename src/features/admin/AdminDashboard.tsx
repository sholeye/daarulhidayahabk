...
export const AdminDashboard: React.FC = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: selectedTerm ? formatCurrency(totalRevenue) : "Select a term",
      change: selectedTerm
        ? `${selectedTerm.name} · ${selectedTerm.session}`
        : "Choose a term to view revenue",
            ...
            {announcements.slice(0, 3).map((ann) => (
              <div key={ann.id} className="p-4 rounded-xl bg-muted/50">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <Badge
                    variant={ann.category === "urgent" ? "unpaid" : "outline"}
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="flex items-center gap-4 p-4 rounded-xl bg-secondary/5">
            ...
            <div>
              <p className="text-2xl font-bold text-foreground">{todayLate}</p>
