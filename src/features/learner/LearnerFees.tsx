...
export const LearnerFees: React.FC = () => {
  ...
  const studentPayments = student
    ? payments.filter((p) => p.studentId === student.studentId)
    : [];
  ...
  const currentAmountPaid = getTermAmountPaid(
    payments,
    student.studentId,
    selectedTerm,
  );
  ...
  const paymentPercentage = getPaymentProgress(currentAmountPaid, currentFee);
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-card rounded-2xl border border-border p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Selected Term Fee</p>
        ...
        <div className="bg-card rounded-2xl border border-border p-6">
          <div className="flex items-center gap-3 mb-4">
            <div
              className={`w-12 h-12 rounded-xl flex items-center justify-center ${feeBalance > 0 ? "bg-destructive/10" : "bg-primary/10"}`}
            >
              {feeBalance > 0 ? (
            ...
            <div>
              ...
              <p
                className={`text-2xl font-bold ${feeBalance > 0 ? "text-destructive" : "text-primary"}`}
              >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  ...
                  {formatCurrency(feeBalance)}. Complete payment to access
                  results.
                </p>
              </div>
            </div>
          ...
          <div className="mt-6 p-4 bg-primary/10 border border-primary/20 rounded-xl">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  All fees paid. Full access granted.
                </p>
              </div>
            </div>
          </div>
              ...
              <tbody className="divide-y divide-border">
                {studentPayments.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <Badge
                        variant={p.status === "completed" ? "paid" : "unpaid"}
                      >
                        {p.status}
                      </Badge>
                    </td>
